...
<div class="con1">
    <div class="con2">
        ...
        <a href="${pageContext.request.contextPath}/customerInfo/queryByName" class="jfj">个人中心></a>
        <span class="jfj">更新个人信息</span>
        <h3>更新个人信息</h3>
        <form action="${pageContext.request.contextPath}/customerInfo/updatecustomer2" name="updatecustomer">
                    ...
                    <div class="col-md-12 column">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>班级</td>
                                <td><input type="text" name="customerClassId" value="${customer.customerClassId}" /></td>
                            </tr>
                            <tr>
                                <td>电话</td>

...
<div class="header">
    ...
    <div class="header2">火车乘员管理系统</div>
    <div class="header3">
...
<div class="nav nav1">
    ...
    <a href="${pageContext.request.contextPath}/jsp/user.jsp">用户信息</a>
    <a href="${pageContext.request.contextPath}/customerInfo/query">客户信息</a>
    <a href="${pageContext.request.contextPath}/clazzInfo/queryClazz">等级信息</a>
    <a href="${pageContext.request.contextPath}/speedInfo/querySpeed"> 速度信息</a>
</div>
</body>
</html>